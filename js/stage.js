...
window.onload = async function ()
{
	...
	//페이지 그리기
	drawPageNew(await stageLoadData, await enemyDataList);
...
async function drawPageNew(stageLoadData, enemyDataList)
{
	...
	//문서 제목
	document.title = 'Stage ' + stageName;
	//뒤로가기 버튼, 상단 제목
	...
	else
	{
		...
		$('#stage-title').html('Stage ' + stageName);
	}
